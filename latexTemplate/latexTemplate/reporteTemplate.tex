...
\email{biden@cua.uam.mx}
\affiliation{%
  \institution{UAM Lerma \\ Ingenier{\'i}a en Computaci{\'o}n y Telecomunicaciones}
  \city{Lerma de Villada}
  \country{M{\'e}xico}
}

%%\author{Carlos A. Coello Coello}
%%\email{ccoello@cua.uam.mx}
%%\affiliation{%
%%  \institution{UAM Cuajimalpa \\ Licenciatura en Matem{\'a}ticas Aplicadas}
%%  \city{Ciudad de M{\'e}xico}
%%  \country{M{\'e}xico}
%%}
